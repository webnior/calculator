...
const platformOffers = {
  amazon: {
    ...
    description:
      "Get a FREE 10-minute consultation worth ₹3,000 to boost your Amazon sales!",
  ...
  myntra: {
    ...
    description:
      "Unlock a FREE 10-minute consultation worth ₹3,000 to scale your Myntra business!",
  ...
  default: {
    ...
    description:
      "Get a FREE 10-minute consultation worth ₹3,000 to accelerate your e-commerce business!",
...
const LeadPopup = () => {
  ...
  const [platform, setPlatform] =
    useState<keyof typeof platformOffers>("default")
          ...
          >
            ...
            {isSuccess ? (
              <div className="rounded-lg bg-green-100 p-4 text-center dark:bg-green-900">
                <svg
                  className="mx-auto mb-2 h-10 w-10 text-green-600 dark:text-green-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <h4 className="mb-1 text-lg font-semibold text-green-800 dark:text-green-200">
                  Thank You!
                </h4>
