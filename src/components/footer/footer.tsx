              ...
              <div className="col-span-2">
                <div>
                  ...
                  <p className="text-gray-500">
                    &quot Stay ahead with e-commerce trends, expert tips, and
                    exciting agency updates. No spam, just quality content for
                    e-commerce success! &quot
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 border-t border-gray-100 pt-8">
            <div className="sm:flex sm:justify-between">
              <p className="text-xs text-gray-500">
                &copy; 2023-24. Technovita Solution. All rights reserved.
              </p>
