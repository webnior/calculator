...
export const metadata: Metadata = {
  title:
    "Blinkit Seller Commission Calculator Process in 2025 | Learn How to Calculate Your Earnings",
  description:
    "Calculate your potential earnings and commissions as a Blinkit seller with our free calculator guide in 2025. Plan your business and maximize profits.",
  keywords:
